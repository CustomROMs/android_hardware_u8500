                                                  ...
                                                  const char *device_address)
{
    ...
    if (AudioSystem::isOutputDevice((android::AudioSystem::audio_devices)device)) {
        if (device & mAvailableOutputDevices) {
            if (AudioSystem::isA2dpDevice((android::AudioSystem::audio_devices)device) &&
                (!mHasA2dp || (address != "" && mA2dpDeviceAddress != address))) {
                return state;
            }
            if (AudioSystem::isBluetoothScoDevice((android::AudioSystem::audio_devices)device) &&
    ...
    } else if (AudioSystem::isInputDevice((android::AudioSystem::audio_devices)device)) {
...
AudioSystem::forced_config AudioPolicyManagerBase::getForceUse(audio_policy_force_use_t usage)
{
