...
ADM_SET_AUDIO_CHIP := u8500_ab8500
...
LOCAL_C_INCLUDES += \
        ...
        $(LOCAL_PATH)/../../multimedia/shared/ens_interface/include/omxil \
        $(LOCAL_PATH)/../../multimedia/shared/ens_interface/nmf/mpc/nmf_repository/mmdsp_x \
        $(LOCAL_PATH)/../../multimedia/shared/utils/include/ \
        $(LOCAL_PATH)/../../multimedia/audio/audio_chipset_apis \
        $(LOCAL_PATH)/../../multimedia/shared/ens_interface/include/ \
        $(LOCAL_PATH)/../../multimedia/audio/afm/proxy/include/ \
        $(LOCAL_PATH)/../../multimedia/shared/ste_shai/include/ \
        $(LOCAL_PATH)/../../multimedia/audio/speech_proc_vcs/wrapper/inc/ \
        $(LOCAL_PATH)/../../multimedia/audio/drc/proxy/ \
	$(LOCAL_PATH)/../../multimedia/audio/comfortnoise/proxy \
	$(LOCAL_PATH)/../../multimedia/audio/afm/proxy \
	$(LOCAL_PATH)/../../multimedia/audio/virtual_surround/proxy \
	$(LOCAL_PATH)/../../multimedia/audio/noise_reduction/proxy \
        $(LOCAL_PATH)/../../multimedia/audio/ \
        $(LOCAL_PATH)/../../multimedia/audio/libeffects/mpc/include/ \
        $(LOCAL_PATH)/../../multimedia/audio/audiolibs/fake_dsptools \
        $(LOCAL_PATH)/../../multimedia/audio/audiolibs/common/include/ \
