...
CN_ENABLE_FEATURE_MAL_MCE := false
CN_ENABLE_FEATURE_MAL_MIS := false
CN_ENABLE_FEATURE_MAL_NET := false
CN_ENABLE_FEATURE_MAL_MIS := false
CN_ENABLE_FEATURE_MAL_RF := false
CN_ENABLE_FEATURE_MAL_MTE := false
CN_ENABLE_FEATURE_MAL_NETLNK := false
CN_ENABLE_FEATURE_MAL_NVD := false
...
LOCAL_LDLIBS := -lm
LOCAL_SHARED_LIBRARIES := libcutils libutils libicuuc liblog
