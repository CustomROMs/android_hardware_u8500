...
COPS_SOCKET_PATH ?= /dev/socket/cops.socket
COPS_DEBUG ?= 2
...
PROCESSING_PATH := $(LOCAL_PATH)/../processing
CN := $(ACCESS_SERVICES_PATH)/call_network/call_network
LOCAL_C_INCLUDES += $(CN)/libcn/include $(LOCAL_PATH)/../../bass_app/teec/include/
...
#COPS_SET_SECURE_WORLD ?=stubbed

EXTENDED_SIPC_MSGS:=true
