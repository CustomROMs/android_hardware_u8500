...
class ThreadHandler : public Thread
{
 ...
 public:
  ...
  /* start */
  inline int init(uint32_t aMaxEvents, bool aSignalCompletion, const char* aName,
 ...
 public:
  /* Handle new request */
  virtual int handleRequest(T& aData) = 0;

  /* Handle flush request */
  virtual int handleFlush(T& aData);
