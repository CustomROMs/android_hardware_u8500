...
int OmxThread<OmxBuffInfo>::handleRequest(OmxBuffInfo& aData)
{
    ...
    int err = handleBuffer(aData, needFlagUpdation);
...
int OmxThread<OmxBuffInfo>::handleFlush(OmxBuffInfo& aData)
{
    DBGT_PROLOG("Buffinfo: %p", &aData);
