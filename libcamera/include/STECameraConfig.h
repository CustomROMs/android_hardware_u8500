...
#define DEFAULT_PRIMARY_PREVIEW_WIDTH 800
#define DEFAULT_PRIMARY_PREVIEW_HEIGHT 480
#define DEFAULT_PRIMARY_PREVIEW_NSTRIDE 800
...
#define SUPPORTED_PRIMARY_PREVIEW_SIZES "1280x720,960x720,800x480,720x480,640x480,352x288,320x240,176x144"
#define SUPPORTED_PRIMARY_FRAMERATES "5,10,15,20,25,30"
#define SUPPORTED_PRIMARY_FPS_RANGES "(5000,30000)"

#define SUPPORTED_PRIMARY_RECORD_SIZES "1280x720,960x720,800x480,720x480,640x480,352x288,320x240,176x144"
/* +CR340479 */
#define DEFAULT_PRIMARY_RECORD_SIZE "0"
 
#define DEFAULT_PRIMARY_VIDEO_RECORD_WIDTH 1280
#define DEFAULT_PRIMARY_VIDEO_RECORD_HEIGHT 720

#define DEFAULT_PRIMARY_FOCAL_LENGTH "5"

// Define below lines for default capture params
#define DEFAULT_PRIMARY_PICTURE_WIDTH 800
...
//#define SUPPORTED_PRIMARY_PICTURE_SIZES "2560x1920,2560x1536,2048x1536,2048x1232,960x720,640x480,352x288,320x240,320x200,176x144"
#else
...
#define DEFAULT_SECONDARY_VIDEO_RECORD_WIDTH 800
...
// Define below lines for default capture params
#define DEFAULT_SECONDARY_PICTURE_WIDTH 800
